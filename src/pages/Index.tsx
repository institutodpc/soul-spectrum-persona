      ...
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 mt-20">
        <div className="max-w-4xl w-full space-y-12 py-12">
          ...
          <div className="text-center space-y-6">
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight holographic-text text-center px-0 md:text-6xl mx-[30px]">
              Descubra qual Perfil está vivendo hoje!
            </h1>
            <p className="text-xl sm:text-2xl max-w-3xl mx-auto md:text-xl">Descubra qual perfil espiritual está te influenciando hoje!</p>
          </div>
